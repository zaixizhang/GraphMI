...
class embedding_graphsage(nn.Module):
    def __init__(self, nfeat, nhid, with_bias=False, device=None):
...
class graphsage(nn.Module):
    ...
    def __init__(self, nfeat, nhid, nclass, dropout=0.5, lr=0.01, weight_decay=5e-4, with_relu=True, with_bias=False, device=None):
